...
# #TASK:
# # In your init - write the feature store yaml, to the project source directory.
# # Do your feast apply
# # We can run feast command as python suprocess.
# # So that we can sip the data and push to s3.
...
#         return FileSource(
#             file_format=ParquetFormat(),
#             path="/Users/adekunleba/MyProjects/mlops/feature_ops/data/item_data.parquet"
#         )
...
#                 self.feature_create("impression_time", ValueType.UNIX_TIMESTAMP),
